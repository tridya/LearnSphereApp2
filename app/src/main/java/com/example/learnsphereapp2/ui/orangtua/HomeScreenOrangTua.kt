// ui/orangtua/HomeScreenOrangTua.kt
...
fun HomeScreenOrangTua(
    ...
    Column(
        ...
        Text(text = "Welcome, Orang Tua $username!", style = MaterialTheme.typography.headlineMedium)
        ...
        Button(
            onClick = {
                ...
                navController.navigate(Destinations.LOGIN) {
                    popUpTo(Destinations.HOME_ORANGTUA) { inclusive = true }
                }
            },
